...
function shuffleCards() {
    return [...CARDS, ...CARDS]
        .map((card, index) => (Object.assign(Object.assign({}, card), { id: index })))
...
function App() {
    ...
    return (<div>
      <Score score={score}/>
      <CardContainer tenCards={tenCards} flipped={flipped} matched={matched} handleCardClick={handleCardClick}/>
